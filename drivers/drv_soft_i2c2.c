...
static struct stm32_soft_i2c2_config soft_i2c_config;
static struct stm32_i2c2 i2c_obj;
 ...
 */
static void stm32_i2c2_gpio_init(struct stm32_i2c2 *i2c)
{
    struct stm32_soft_i2c2_config* cfg = (struct stm32_soft_i2c2_config*)i2c->ops.data;
...
{
    struct stm32_soft_i2c2_config* cfg = (struct stm32_soft_i2c2_config*)data;
    if (state)
    {
        rt_pin_write(cfg->sda, PIN_HIGH);
    }
 ...
 */
static rt_err_t stm32_i2c_bus_unlock(const struct stm32_soft_i2c2_config *cfg)
{
    rt_int32_t i = 0;
...
int rt_hw_i2c2_init(char *name, rt_uint8_t scl, rt_uint8_t sda)
{
    rt_err_t result;
